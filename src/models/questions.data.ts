...
This is a classic problem to test basic input/output handling and arithmetic operations in your programming language of choice.`,
    ...
    testCases: [
      ...
      { input: '-500 -300', expectedOutput: '-800' },
...
This is a classic programming exercise that tests your understanding of conditional logic and loops.`,
    ...
    constraints: [
      ...
      'It is guaranteed that $l \\leq r$.'
    ],
    examples: [
      {
        input: '1 15',
        output: '1\n2\nFizz\n4\nBuzz\nFizz\n7\n8\nFizz\nBuzz\n11\nFizz\n13\n14\nFizzBuzz',
        explanation: 'Classic FizzBuzz from 1 to 15. Note that 15 is divisible by both 3 and 5, so it prints "FizzBuzz".'
      },
      {
        input: '13 16',
        output: '13\n14\nFizzBuzz\n16'
    ...
    testCases: [
      { input: '1 15', expectedOutput: '1\n2\nFizz\n4\nBuzz\nFizz\n7\n8\nFizz\nBuzz\n11\nFizz\n13\n14\nFizzBuzz' },
      { input: '13 16', expectedOutput: '13\n14\nFizzBuzz\n16' },
      { input: '1 1', expectedOutput: '1' },
      { input: '15 15', expectedOutput: 'FizzBuzz' },
      { input: '3 3', expectedOutput: 'Fizz' },
      { input: '5 5', expectedOutput: 'Buzz' },
      { input: '1 5', expectedOutput: '1\n2\nFizz\n4\nBuzz' },
      { input: '30 30', expectedOutput: 'FizzBuzz' },
      { input: '14 17', expectedOutput: '14\nFizzBuzz\n16\n17' },
      { input: '7 12', expectedOutput: '7\n8\nFizz\nBuzz\n11\nFizz' }
    ]
  }
]